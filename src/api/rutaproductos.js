...
class ProductoController {
  ...
  async listar(req, res){
    try{
      ...
      //Obtener Uno
      const producto = await productModel.get(Number(id))
  ...
  async actualizar(req, res){
    try{
      ...
      const producto = await productModel.update(Number(req.params.id), data)
  ...
  async borrar (req, res){
    try{
      const producto = await  productModel.delete(Number(req.params.id))
