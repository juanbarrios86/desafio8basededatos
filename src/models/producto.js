...
//const { knexMysql:knex } = require ('../database/drop')//este borra las tablas, si existen
//const { knexMysql:knex } = require ('../database/migracion')//esto solo para el inicio al crear la tabla
